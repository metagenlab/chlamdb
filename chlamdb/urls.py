...
urlpatterns = [        url('^robots.txt$', TemplateView.as_view(template_name='robots.txt', content_type='text/plain')),
                       ...
                       url(r'^species_tree/$', views.species_tree, name="species_tree"),
                       ...
                       url(r'^index_comp/([a-zA-Z0-9_\.\-]+)', views.index_comp, name="index_comp"),
                       url(r'^entry_list_pfam$', views.entry_list_pfam, name="entry_list_pfam"),
                       url(r'^entry_list_cog$', views.entry_list_cog, name="entry_list_cog"),
                       url(r'^entry_list_ko$', views.entry_list_ko, name="entry_list_ko"),
                       url(r'^entry_list_tcdb$', views.entry_list_tcdb, name="entry_list_tcdb"),
                       url(r'^entry_list_interpro$', views.entry_list_interpro, name="entry_list_interpro"),
                       url(r'^entry_list_tcdb$', views.entry_list_tcdb, name="entry_list_tcdb"),
                       url(r'^cog_comparison$', views.cog_comparison, name="cog_comparison"),
                       ...
                       url(r'^interpro_profile/([a-zA-Z0-9_\.:]+)/([a-zA-Z0-9_\.]+)', views.interpro_profile, name="interpro_profile"),
                       url(r'^interpro_signature_profile/([a-zA-Z0-9_\.:]+)/([a-zA-Z0-9_\.]+)', views.interpro_signature_profile, name="interpro_signature_profile"),
                       url(r'^get_pfam_taxon_table/([a-zA-Z0-9_\.]+)', views.get_pfam_taxon_table, name="get_pfam_taxon_table"),
                       url(r'^get_interpro_taxon_table/([a-zA-Z0-9_\.]+)', views.get_interpro_taxon_table, name="get_interpro_taxon_table"),
                       ...
                       url(r'^get_interpro_hit_list/([a-zA-Z0-9_\.]+)/(.*)/(.*)/(.*)/(.*)/(.*)', views.get_interpro_hit_list, name="get_interpro_hit_list"),
                       url(r'^get_interpro_hit_list/([a-zA-Z0-9_\.]+)/(.*)/(.*)/(.*)/(.*)', views.get_interpro_hit_list, name="get_interpro_hit_list"),
                       url(r'^get_interpro_hit_list/([a-zA-Z0-9_\.]+)/(.*)/(.*)/(.*)', views.get_interpro_hit_list, name="get_interpro_hit_list"),
                       url(r'^get_interpro_hit_list/([a-zA-Z0-9_\.]+)/(.*)/(.*)/', views.get_interpro_hit_list, name="get_interpro_hit_list"),
                       url(r'^get_interpro_hit_list/([a-zA-Z0-9_\.]+)/(.*)/', views.get_interpro_hit_list, name="get_interpro_hit_list"),
                       ...
                       url(r'^cog_venn_subset/([a-zA-Z0-9_\.\%-]+)$', views.cog_venn_subset, name="cog_venn_subset"),
                       ...
                       url(r'^orthogroup_conservation_tree/([a-zA-Z0-9_\.\-]+)$', views.orthogroup_conservation_tree, name="orthogroup_conservation_tree"),
                       ...
                       url(r'^fam_tcdb/([a-zA-Z0-9_\.]+)/([a-zA-Z0-9_\.]+)', views.fam_tcdb, name="fam_tcdb"),
                       ...
                       url(r'^cog_subset_barchart/$', views.cog_subset_barchart, name="cog_subset_barchart"),
                       ...
                       url(r'^extract_tcdb/$', views.extract_tcdb, name="extract_tcdb"),
                       url(r'^extract_tcdb/([a-zA-Z0-9_]+)$', views.extract_tcdb, name="extract_tcdb"),                       
                       ...
                       url(r'^venn_tcdb/$', views.venn_tcdb, name="venn_tcdb"),
                       ...
                       url(r'^tcdb_comparison', views.tcdb_comparison, name="tcdb_comparison"),
