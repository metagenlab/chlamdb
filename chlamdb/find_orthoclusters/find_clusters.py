...
create_locus_link_table('chlamydia_04_16')
create_taxon_link_table_locus('chlamydia_04_16')
locus_links, taxon_links = find_clusters_of_locus('chlamydia_04_16', 60, 20000)

insert_locus_links_into_mysql('chlamydia_04_16', locus_links)
insert_taxon_links_into_mysql_locus('chlamydia_04_16', taxon_links)
